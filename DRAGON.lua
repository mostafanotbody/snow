...
io.write('\27[1;31m 💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞  ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
local UserName = (data.username_ or "QW_Q1Q1")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'سناو') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
❤سعر التنصيب علي سورس سناو 
↯مجاني عشآن احنا عاملين السورس لاخواتنا مش عشآن فلوس 
❤للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙴𝚇𝙴𝙵𝙰𝚁',url="t.me/eXeFaAR"}},
{{text = ' 𝚁𝙾𝙺𝚂',url="t.me/juust_oO"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المطور اكسيفر💖 ',url="t.me/eXeFaAR"}}, 
{{text = 'المطور روكس💖   ', url="t.me/juust_oO"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevSoFi(msg) then
local bl = 'اهلا بكم ومرحبا ف سورس سناو'
local keyboard = {
...
local Text = ' ❤تم ارسال الملصق من 💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═?? \n - '..Name
...
send(msg.chat_id_, msg.id_,' ❤ اصدار سورس سناو{ 4x}')
end
if text == '━┅┅┄⟞⟦ مطورين السورس ⟧⟝┄┉┉━' then
local Text = [[ 
قناه يوزرات مطورين ومبرمجين السورس 💕❤.
محتاج تنصب بوت ببلاش تواصل معانا 🏴‍☠️⬇️.
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="t.me/hogan21"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sasa7_7/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[قناه سورس سناو ادخل وتابع الجديد](t.me/QW_Q1Q1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/QW_Q1Q1)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/QW_Q1Q1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ❤ من أحسن السورسات على التليجرام سورس سناو ❤
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "سناو")
...
send(msg.chat_id_,0," ❤ الـعـضو  : {["..data.first_name_.."](T.ME/QW_Q1Q1)}\n ❤ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❤ عذرا  ⇦↯{["..data.first_name_.."](T.ME/QW_Q1Q1)}\n ❤ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local QW_Q1Q1 = database:get(bot_id..'text:ch:user')
if QW_Q1Q1 then
send(msg.chat_id_, msg.id_,'['..QW_Q1Q1..']')
else
send(msg.chat_id_, msg.id_,' 💞  لا تستطيع استخدام البوت \n  💞  يرجى الاشتراك بالقناه اولا \n  💞  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
local Text = [[
 𖠪 اهلا بك في سورس سناو الجمدان 𖠪
 𖠪 عايز بوت ببلاش وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝙴𝚇𝙴𝙵𝙰𝚁',url="t.me/eXeFaAR"},{text = ' 𝚁𝙾𝙺𝚂', url="t.me/juust_oO"}},
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/eXeFaAR&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[
مطورين ومبرمجين سورس سناو اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور اكسيفر',url="t.me/eXeFaAR"}},
{{text = 'مطور روكس',url="t.me/juust_oO"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == '《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ' then
local Text = [[ 
 ❤من أحسن السورسات على التليجرام سورس سناو ❤
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆](http://t.me/QW_Q1Q1)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ', url="t.me/QW_Q1Q1"}}, 
...
local Text = [[  
 ❤ اهلا في قائمه الالعاب المتطوره سورس سناو ❤ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/QW_Q1Q1)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1969402719) then  
...
function(arg,data) 
usertext = '\n ❤ الـعـضو   ⇦↯['..data.first_name_..'](t.me/'..(data.username_ or 'QW_Q1Q1')..')'
...
usertext = '\n ❤ الـعـضو   ⇦↯['..result.title_..'](t.me/'..(username or 'QW_Q1Q1')..')'
status  = '\n ❤ تم حظرو عام من الجروبات '
texts = usertext..status
...
if Get_info then
local TextS = "\n ❤ اهلا بك في متجر ملفات سناو\n ❤ ملفات السورس 💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 \n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 \n ❤ علامة تعني { ✔️ } ملف مفعل\n ❤ علامة تعني { ✖ } ملف معطل\n ❤ قناة سورس سناو💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 \n".." ❤ [اضغط هنا لدخول](t.me/QW_Q1Q1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❤ عذرا الملف لايدعم سورس سناو\n") 
end
return false
end
...
if text == ("مسح قائمه سناو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ❤ تم مسح قائمه سناو')
return false
end

if text == 'قائمه سناو' and Sudo(msg) then
...
if text == ("رفع سناو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سناو@(.*)$") and Sudo(msg) then
local username = text:match("^رفع سناو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع سناو(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سناو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل سناو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سناو@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سناو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل سناو(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سناو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ❤  الايدي بالصوره  ⇦↯{ '..idph..
' }\n'..' ❤  الرفع  ⇦↯{ '..setadd..
' }\n'..' ❤  الحظر  ⇦↯{ '..banm..' }\n\n ❤═───═❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ](t.me/QW_Q1Q1)❳═───═ ❤\n ❤ قناة سورس سناو💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 \n [ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ](t.me/QW_Q1Q1)❳](t.me/QW_Q1Q1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 \nاضغط علي الاسم ليتم نسخه\n💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 ٴ\n ❤ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ](t.me/QW_Q1Q1)❳ ❤ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سناو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سناو')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس سناو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝚂𝙾𝚄𝚁𝙲?? 𝚂𝙽𝙾𝚆》', url="t.me/QW_Q1Q1"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 《𝚂𝙾𝚄𝚁𝙲𝙴 𝙷𝙾??𝙰??》', url="t.me/QW_Q1Q1"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس سناويعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سناو').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري ولازم اعرصلك ينور عنيا🥺🤍](t.me/QW_Q1Q1)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
[🎯ألعاب سورس سناو الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ](t.me/QW_Q1Q1)
]]
keyboard = {} 
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 
 اختر الامر الذي تريدها .↑💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 
ده من الازرار بلاسفل . 💞 ═───═⟦𝚂𝙽𝙾𝚆⟧═───═💞 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ](t.me/QW_Q1Q1)❳ 
]]
keyboard = {} 
...
{
{text = '( source hogan )', url="t.me/QW_Q1Q1"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝙽𝙾𝚆》 ](t.me/QW_Q1Q1)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سناو')
